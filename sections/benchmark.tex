...
\begin{enumerate}
    ...
    \item \textbf{P.2} - Addition or removal of UNION or OPTIONAL clauses, which change whether a FILTER can be pushed down or not.
...
\TODO{Explain the connection with the literature (specifically the olaf paper)}

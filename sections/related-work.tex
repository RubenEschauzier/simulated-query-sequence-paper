...
This organic interaction likely \rt{This "likely" here is dangerous. Reviewers might raise concerns because of it. I would phrase it as something like: "As organic interactions as a property of the application, and not the way data is organized, we assume that these characteristics also occur in applications over decentralized environments."} represents the primary method users will use to navigate structured decentralized environments.
Furthermore, we deprioritize robotic queries because their sequences can already be simulated by traditional benchmark approaches.
...
Previous work~\cite{zhang2020characterizing} defined three types of robotic patterns: \rt{If you run into space issues, this could be cut or shortened. Since you don't focus on robotic patterns.}  
\begin{itemize}
...
\end{itemize}
These patterns are already simulated by current benchmarks~\cite{taelman2023link,bizer2011berlin,alucc2014diversified} 
using instantiations of query templates.

...
In this paper, we address this gap in existing benchmarks by introducing SolidSeqBench, a new benchmark that builds upon SolidBench~\cite{taelman2023link} to generate realistic query sequences.
